...
//     int steps = 0, visualization_flag = 0, dbg_print = 0;
//     double theta = 0.0, dt = 0.0;

//     // Master process parses arguments
//     if (rank == 0) {
//         argument_parse(argc, argv, &input_filename, &output_filename, &steps, &theta, &dt, &visualization_flag, &dbg_print);
//     }
...
//     if (dbg_print == 1) { // Print only from the master process in MPI
